...
namespace naloga_6
{
    public partial class NavadenUporabnik : System.Web.UI.Page
    {
        ...
        {
            List<ServiceReference1.Student> uporabniki = StudentskiDomovi.PridobiVseStudente().ToList();

            SeznamStudentov1.DataSource = uporabniki;
            SeznamStudentov1.DataBind();
        }

        protected void button_izpisvsehdomov_Click(object sender, EventArgs e)
        {
            SeznamDomov1.DataSource = StudentskiDomovi.PridobiVseDomove();
            SeznamDomov1.DataBind();
        }
